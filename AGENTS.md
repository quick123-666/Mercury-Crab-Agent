...
Current mode: **Active** (suggest patterns after 3x repetition)

- 犯错/被纠正 → 记录到 `~/self-improving/corrections.md`
- 发现模式(3次以上) → 提议写入 `~/self-improving/memory.md`
- 每个 heartbeat → 检查 corrections.md，整理学习成果
- 严格遵守 `boundaries.md` 安全边界
